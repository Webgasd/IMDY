...
public interface SupervisionEnterpriseCreditService {
    ...
    PageResult<SupervisionEnterpriseCreditParamDetail> getCreditPage(SupervisionEnterpriseCreditSearchParam supervisionEnterpriseCreditSearchParam, SysUser sysUser, PageQuery pageQuery);
