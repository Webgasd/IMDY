...
public class GridPointsServiceImpl implements GridPointsService {
    ...
    @Override
    public List<NearEnterprise> getNearEnterprise(EnterpriseSearchParam enterpriseSearchParam){
        ...
        Float gps4 = (float) (gpsB + enterpriseSearchParam.getDis() * 0.00000899);
        //根据中心点上下左右距离内取点
        List<NearEnterprise> nearEnterpriseList = gridPointsMapper.getNearEnterprise(enterpriseSearchParam,gps1,gps2,gps3,gps4,0);
