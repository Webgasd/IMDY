...
public class RedisService {
    ...
    public Object getUser(KeyPrefix prefix,String key) {
...
//            Set<String> keys = redisTemplate.keys(prefix.getPrefix()+value.getId().toString()+"_"+"*");
//            redisTemplate.delete(keys);
    ...
    public void delUser(KeyPrefix prefix,String key) {
        String realKey  = prefix.getPrefix() + key;
        if (key != null ) {
