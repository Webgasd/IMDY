...
public class NearEnterprise implements Comparable<NearEnterprise> {
    ...
    public String getDynamicGrade() {
        return dynamicGradeEx;
    }

    public void setDynamicGrade(String dynamicGradeEx) {
        this.dynamicGradeEx = dynamicGradeEx;
    }
}
